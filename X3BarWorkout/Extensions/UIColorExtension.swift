...
//  X3BarWorkout
//
//  Created by David Fish on 11/10/19.
...
extension UIColor {
    public convenience init?(hexString: String) {
        ...
        if hexString.hasPrefix("#") {
            ...
            //let hexColor = hexString.substring(from: start) //substring deprecated
            let hexColor = String(hexString[start...]) // Replaces Susbstring            
            if hexColor.count == 8 {
